...
var help_message =
    'You must pass one argument to build-pngs. It should be target dimension in the format `200:` for width 200px, or `:200` for height 200px.';
...
function convert_all_files(svgs, callback) {
    ...
    function do_next_file() {
        console.log(
            'Converting [' + (i + 1) + '/' + svgs.length + '] ' + svgs[i]
        );
