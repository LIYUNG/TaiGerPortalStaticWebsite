...
import type { EditorStateData } from './EditorSimple';
...
const EditorNew = (props: EditorNewProps) => {
    ...
    useEffect(() => {
        setEditorState(props.editorState ?? { time: 0, blocks: [] });
    }, [props.editorState]);
    ...
    useEffect(() => {
        const initEditor = () => {
            ...
            } as Parameters<typeof EditorJS>[0]) as EditorJS;
        };
