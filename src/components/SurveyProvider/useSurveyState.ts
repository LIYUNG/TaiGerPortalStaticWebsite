...
export interface SurveyStateActions {
...
export interface UseSurveyStateOptions {
    initialValue: SurveyStateValue;
    onSuccess?: () => void;
}
...
export function useSurveyState({
    initialValue,
    onSuccess
}: UseSurveyStateOptions): SurveyStateActions {
    const [surveyState, setSurveyState] =
        useState<SurveyStateValue>(initialValue);
