...
const AgentPage = () => {
    ...
    const stats = useMemo(() => {
        ...
        const decidedYesCount = applications.filter((app) =>
        ...
        // Pending = Decided "O" but not yet submitted (closed = "-")
        const pendingCount = applications.filter(
            (app) => isProgramDecided(app) && !isProgramSubmitted(app)
        ).length;
