...
export const getSameProgramStudents = ({
    programId
}: {
    programId: string;
}) =>
...
export const updateSchoolAttributes = (
    schoolAttributes: ApiPayload
) =>
...
export const getCommunicationThreadV2 = ({ studentId }: { studentId: StudentId }) =>
...
export const getStudentMeeting = (
    studentId: StudentId,
    meetingId: MeetingId
) =>
