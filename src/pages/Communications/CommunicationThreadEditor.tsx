...
const CommunicationThreadEditor = (props: CommunicationThreadEditorProps) => {
    ...
    const insertSuggestion = useCallback(() => {
        if (!streamingData.data) return;
        const blocks = markdownToEditorJsBlocks(streamingData.data);
