...
| # | Lines | Path (relative to `src/`) |
|---|-------|----------------------------|
| 1 | 2385 | pages/Survey/SurveyEditableComponent.tsx |
| 2 | 2005 | pages/InterviewTraining/SingleInterview.tsx |
| 3 | 1900 | pages/MyCourses/CourseAnalysisV2.tsx |
| 4 | 1354 | pages/CVMLRLCenter/DocModificationThreadPage/components/InformationBlock.tsx |
| 5 | 1334 | pages/Program/ProgramsOverviewPage.tsx |
| 6 | 1266 | pages/CRM/LeadPage.tsx |
| 7 | 1256 | pages/CVMLRLCenter/DocModificationThreadPage/DocModificationThreadPage.tsx |
...
| Priority | File | Why |
|----------|------|-----|
| **P0** | SurveyEditableComponent.tsx (2385) | Single huge form/survey UI; split into step/section components and shared form fields. |
| **P0** | SingleInterview.tsx (2005) | Interview flow; extract sections (header, form, calendar, feedback) and hooks. |
| **P0** | CourseAnalysisV2.tsx (1900) | Course analysis; split by feature (tabs, tables, modals) and move logic to hooks. |
| **P0** | InformationBlock.tsx (1354) | CV/ML/RL info block; split by subsection and reuse small presentational components. |
| **P0** | ProgramsOverviewPage.tsx (1334) | Program overview; extract table, filters, and detail panels. |
| **P1** | LeadPage.tsx (1266) | CRM lead; split lead header, timeline, and forms into subcomponents. |
| **P1** | DocModificationThreadPage.tsx (1256) | Doc thread; extract thread list, message view, and input area. |
| **P1** | SingleProgramView.tsx (1252) | Program view; extract requirement sections, lock UI, and actions. |
